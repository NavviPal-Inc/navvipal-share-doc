...
const AppDownloadBanner = () => {
  return (
    <div className="app-download-banner">
      <h3>Get NavviPal for Free</h3>
      <p>
        The world's first smart vault for your most important documents — powered by AI 
        for effortless security, organization, and peace of mind.
      </p>
